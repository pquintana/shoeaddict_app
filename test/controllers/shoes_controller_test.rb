...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { color: @shoe.color, description: @shoe.description, designer: @shoe.designer, name: @shoe.name, picture: @shoe.picture }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { color: @shoe.color, description: @shoe.description, designer: @shoe.designer, name: @shoe.name, picture: @shoe.picture }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
